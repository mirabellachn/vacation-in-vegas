...
//  VacationInVegas
//
//  Created by mirabella  on 22/10/24.
//
...
class Place {
    ...
    static var previewPlaces: [Place] {
        [
            Place(name: "Bellagio", latitude: 36.1129, longitude: -115.1765, interested:
                    true),
            Place(name: "Paris", latitude: 36.1125, longitude: -115.1707, interested:
                    true),
            Place(name: "Treasure Island 1", latitude: 36.1247, longitude: -115.1721,
                  interested: false),
